...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		btnCerrar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnCerrar.setBackground(new Color(118, 187, 223));				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnCerrar.setBackground(new Color(12, 138, 199));	
			}
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		btnCerrar.setBounds(0, 369, 257, 56);
		btnCerrar.setBackground(new Color(12, 138, 199));
		panelMenu.add(btnCerrar);
		btnCerrar.setLayout(null);
		
		JLabel lblCerra = new JLabel("Salir del sistema");
		lblCerra.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/cerrar-sesion 32-px.png")));
		lblCerra.setBounds(27, 11, 200, 34);
		lblCerra.setHorizontalAlignment(SwingConstants.LEFT);
		lblCerra.setForeground(Color.WHITE);
		lblCerra.setFont(new Font("Roboto", Font.PLAIN, 18));
		btnCerrar.add(lblCerra);
                /*------------------------------------------------------------*/
