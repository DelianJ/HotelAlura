...
public class RegistroHuesped extends JFrame {
    ...
    private JPanel contentPane, btnguardar;
    ...
    private void configuraBoton(){
        btnguardar.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                if ((txtNombre != null) && (txtApellido != null) && (txtFechaN.getCalendar() != null)
                        && (txtNacionalidad != null) && (txtTelefono != null) && (txtNreserva != null)) {
                    guardaHuesped();
                } else {
    ...
    private void guardaHuesped() {
        ...
        int idhuesped = huespedcontroller.guardar(new Huesped(nombre, apellido,
                fechaN, nacionalidad, telefono, reserva));
        if (idhuesped == 0) {
            JOptionPane.showMessageDialog(null, "Ocurrio un error al guardar los dalos del huesped,"
                    + "\nPor favor intente otra vez", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            String mensaje = "huesped: " + nombre + ", con ID: " + idhuesped
                    + ", y reserva : " + reserva;
